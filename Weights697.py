# Chef is playing with weights. He has an object weighing W
# W units. He also has three weights each of X,Y and Z units respectively.
...
for r in range(int(input())):
  ...
  if w==x or w==y or w==z or w==(x+y+z) or w==(x+y) or w==(y+z) or w==(z+x):
    print("YES")
  else:
    print("NO")
